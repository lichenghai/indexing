...
import com.jidi.standard.mapper.LeaderCommentMapper;
...
@Service
@Transactional
public class LeaderCommentService extends AbstractService<LeaderComment> {
    @Resource
    private LeaderCommentMapper leaderCommentMapper;
